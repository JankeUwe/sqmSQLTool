...
$cats['konfiguration']       = @{ Title="$([char]::ConvertFromUtf32(0x2699))$([char]::ConvertFromUtf32(0xFE0F)) Configuration"; Badge='konfiguration'; Text='Configuration' }
...
$members = [ordered]@{}
$members['alwayson'] = 'Add-sqmDatabaseToAG','Compare-sqmAlwaysOnLogins','Complete-sqmListenerMigration','Export-sqmAlwaysOnConfiguration','Get-sqmAlwaysOnFailoverHistory','Get-sqmAlwaysOnHealthReport','Invoke-sqmFailover','Invoke-sqmSqlAlwaysOnAutoseeding','Move-sqmAlwaysOnListener','New-sqmAlwaysOnRepairJob','New-sqmAutoLoginCompareJob','New-sqmAutoLoginSyncJob','Remove-sqmDatabaseFromAG','Repair-sqmAlwaysOnDatabases','Sync-sqmAgNode','Sync-sqmLoginsToAlwaysOn'
...
$members['backup-&-restore'] = 'Invoke-sqmLogShrink','Invoke-sqmRestoreDatabase','Invoke-sqmUserDatabaseBackup','New-sqmBackupMaintenanceJob','New-sqmOlaSysDbBackupJob','New-sqmOlaUsrDbBackupJob','Set-sqmBackupExcludePermission','Sync-sqmBackupExcludeTable','Test-sqmBackupIntegrity'
$members['sicherheit'] = 'Enable-sqmMonitoringAccess','Get-sqmADAccountStatus','Get-sqmADGroupMembers','Get-sqmLoginSettings','Get-sqmSysadminAccounts','Invoke-sqmLoginAudit','Invoke-sqmSaObfuscation','Remove-sqmAdOrphanLogin','Set-sqmDatabaseOwner'
$members['diagnose-&-health'] = 'Copy-sqmNTFSPermissions','Get-sqmConnectionStats','Get-sqmDatabaseHealth','Get-sqmDiskInfoByDriveLetter','Get-sqmDiskSpaceReport','Get-sqmOperationStatus','Get-sqmOrphanedFiles','Get-sqmSpnReport','Get-sqmSQLInstanceCheck','Get-sqmTempDbRecommendation','Invoke-sqmPatchAnalysis','Invoke-sqmSetupReport','New-sqmAgentProxy','Test-sqmCostThreshold','Test-sqmTempDbFileCount'
$members['performance'] = 'Get-sqmAutoGrowthReport','Get-sqmBlockingReport','Get-sqmDeadlockReport','Get-sqmIndexFragmentation','Get-sqmLongRunningQueries','Get-sqmMissingIndexes','Get-sqmPerfCounters','Get-sqmWaitStatistics','Invoke-sqmExtendedEvents','Invoke-sqmPerfBaseline','Invoke-sqmQueryStore','Invoke-sqmUpdateStatistics'
$members['wartung'] = 'Invoke-sqmFormatDrive64k','Test-sqmOlaInstallation','Test-sqmSQLFirewall'
$members['konfiguration'] = 'Compare-sqmServerConfiguration','Get-sqmConfig','Get-sqmServerSetting','Invoke-sqmCollationChange','Invoke-sqmSetDatabaseRecoveryMode','Invoke-sqmSsisConfiguration','Set-sqmConfig','Set-sqmSsrsConfiguration','Set-sqmTcpPort'
...
$members['cluster-&-dienste'] = 'Get-sqmClusterInfo','Test-sqmSsasDirectoryPermissions','Test-sqmSSISPackageCompatibility'
...
$members['sonstige'] = 'Copy-sqmLogins','Copy-sqmToCentralPath','Get-sqmAgentJobHistory','Get-sqmDiskBlockSize','Get-sqmHpuAllowGroup','Get-sqmServerHardwareReport','Install-sqmAdModule','Install-sqmDb2Driver','Install-sqmJdbcDriver','Install-sqmOdbcDriver','Install-sqmOlaMaintenanceSolution','Install-sqmSsrsReportServer','Invoke-sqmMonitoringKey','New-sqmOlaMaintenanceJobs','New-sqmRandomSaPassword','Set-sqmSqlPolicyState','Test-sqmDriverInstalled','Test-sqmMaxDop','Test-sqmMaxMemory','Test-sqmModuleUpdate','Test-sqmSqlInstanceInstalled','Test-sqmUpdateViaGitHub','Test-sqmUpdateViaPSGallery','Test-sqmUpdateViaUNC','Uninstall-sqmDb2Driver','Uninstall-sqmJdbcDriver','Uninstall-sqmOdbcDriver','Update-sqmModule'
