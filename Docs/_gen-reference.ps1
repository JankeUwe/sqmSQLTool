...
$members = [ordered]@{}
$members['alwayson'] = 'Add-sqmDatabaseToAG','Compare-sqmAlwaysOnLogins','Complete-sqmListenerMigration','Export-sqmAlwaysOnConfiguration','Get-sqmAlwaysOnFailoverHistory','Get-sqmAlwaysOnHealthReport','Invoke-sqmAlwaysOnSetup','Invoke-sqmFailover','Invoke-sqmServiceBrokerAlwaysOn','Invoke-sqmSqlAlwaysOnAutoseeding','Move-sqmAlwaysOnListener','New-sqmAlwaysOnRepairJob','New-sqmAutoLoginSyncJob','New-sqmAvailabilityGroup','Remove-sqmDatabaseFromAG','Repair-sqmAlwaysOnDatabases','Sync-sqmAgNode','Sync-sqmLoginsToAlwaysOn'
...
$members['backup-&-restore'] = 'Invoke-sqmLogShrink','Invoke-sqmRestoreDatabase','Invoke-sqmUserDatabaseBackup','New-sqmBackupMaintenanceJob','New-sqmOlaSysDbBackupJob','New-sqmOlaUsrDbBackupJob','Register-sqmBackupExcludeTrigger','Set-sqmBackupExcludePermission','Show-sqmBackupExcludeForm','Sync-sqmBackupExcludeTable','Test-sqmBackupIntegrity'
$members['sicherheit'] = 'Enable-sqmMonitoringAccess','Get-sqmADAccountStatus','Get-sqmADGroupMembers','Get-sqmADGroupMembersRecursive','Get-sqmADMemberGroups','Get-sqmLoginSettings','Get-sqmSysadminAccounts','Grant-sqmTemporarySysadmin','Invoke-sqmLoginAudit','Invoke-sqmSaObfuscation','Invoke-sqmTempSysadminAction','Remove-sqmAdOrphanLogin','Set-sqmDatabaseOwner'
$members['diagnose-&-health'] = 'Copy-sqmNTFSPermissions','Get-sqmAgentJobScheduleReport','Get-sqmConnectionStats','Get-sqmDatabaseHealth','Get-sqmDiskInfoByDriveLetter','Get-sqmDiskPartitionMap','Get-sqmDiskSpaceReport','Get-sqmOperationStatus','Get-sqmOrphanedFiles','Get-sqmServiceBrokerHealth','Get-sqmSpnReport','Get-sqmSQLInstanceCheck','Get-sqmTempDbRecommendation','Invoke-sqmPatchAnalysis','Invoke-sqmSetupReport','New-sqmAgentProxy','New-sqmSetupReport','Test-sqmCostThreshold','Test-sqmTempDbFileCount'
...
$members['konfiguration'] = 'Compare-sqmServerConfiguration','Enable-sqmServiceBroker','Get-sqmConfig','Get-sqmServerSetting','Invoke-sqmCollationChange','Invoke-sqmSetDatabaseRecoveryMode','Invoke-sqmSsisConfiguration','Set-sqmConfig','Set-sqmMaxDop','Set-sqmMaxMemory','Set-sqmSsrsConfiguration','Set-sqmTcpPort'
$members['inventar-&-suche'] = 'Export-sqmDatabaseDocumentation','Export-sqmServerConfiguration','Find-sqmDatabaseObject','Get-sqmLinkedServerUsage','Get-sqmServersFromOU','Invoke-sqmConfigRollback','Invoke-sqmInstanceInventory'
