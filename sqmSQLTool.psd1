...
@{
	...
	# FunctionsToExport: Wildcard Pattern
	# NOTE: Explizite Liste wurde entfernt weil sie PowerShell WARNING über "restricted characters"
	#       verursachte (aufgrund der Bindestriche in Verb-Noun Namen: Get-sqmXxx, Invoke-sqmXxx etc.)
	# Die WARNING war harmlos aber verunsicherte Kunden.
	# LÖSUNG: Wildcard '*' zurück — Export-ModuleMember in .psm1 kontrolliert die echte Export-Liste
	#         mit expliziten Namen + -Cmdlet @() -Variable @() -Alias @() für maximale Kontrolle
	FunctionsToExport	   = '*'
