...
@{
	...
	# HINWEIS: FunctionsToExport wird von Export-ModuleMember in sqmSQLTool.psm1 verwaltet
	# Dies erlaubt dynamische Exporte und verhindert Konflikte zwischen .psd1 und .psm1
	# Die .psd1 enthält daher ein leeres Array, damit .psm1 die Kontrolle hat.
	FunctionsToExport	   = @()
