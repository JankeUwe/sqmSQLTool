...
@{
	...
	# Explizite Liste aller exportierten Funktionen (für Intellisense in ISE/VS Code)
	# Export-ModuleMember in sqmSQLTool.psm1 verwaltet das Laden — diese Liste ist NUR für IDE-Support
	FunctionsToExport	   = @(
