...
$sqmNlpSynonyms = @{
	...
	'datei verschieben'	= @('Move-sqmDatabaseFile')
	'dateien verschieben' = @('Move-sqmDatabaseFile')
	'mdf verschieben'	= @('Move-sqmDatabaseFile')
	'ldf verschieben'	= @('Move-sqmDatabaseFile')
	'tempdb verschieben' = @('Move-sqmDatabaseFile', 'Get-sqmTempDbRecommendation')
	'tempdb umziehen'   = @('Move-sqmDatabaseFile')
	'auf anderes laufwerk' = @('Move-sqmDatabaseFile')
	'laufwerk wechseln' = @('Move-sqmDatabaseFile')
	'datenbank umziehen' = @('Move-sqmDatabaseFile', 'Invoke-sqmRestoreDatabase')
	'log auf eigene platte' = @('Move-sqmDatabaseFile')
	'platte zu klein'   = @('Move-sqmDatabaseFile', 'Get-sqmDiskSpaceReport')
	'verwaiste user'    = @('Invoke-sqmDatabaseStandardization')
	'orphaned user'     = @('Invoke-sqmDatabaseStandardization')
	'user ohne login'   = @('Invoke-sqmDatabaseStandardization')
	'kompatibilitaet'   = @('Invoke-sqmDatabaseStandardization')
	'kompatibilitätsstufe' = @('Invoke-sqmDatabaseStandardization')
	'compatibility level' = @('Invoke-sqmDatabaseStandardization')
	'recovery time'     = @('Invoke-sqmDatabaseStandardization')
